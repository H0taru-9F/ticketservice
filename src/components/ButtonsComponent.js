...
const ButtonV1 = ({onClick,title,width}) => {
    ...
    return(
        <div className='Button-text-1'>
            <button className='button V1 tx-white bg-blue' style={buttonStyles} onClick={onClick}>{title}</button>
        </div>
    );
};
const ButtonV2 = ({onClick,title,width}) => {
    ...
    return(
        <div className='Button-text-1 '>
            <button className='button V2 tx-blue bg-none' style={Style} onClick={onClick}>{title}</button>
        </div>
    );
};
