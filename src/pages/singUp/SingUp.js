...
const SignUp = () => {
    ...
    return(
        <div className="SignUp">
            <div className='SignUp-Form bg-white50'>
                <h3 className='Card-title tx-blue Caption'><b>Реєстрація</b></h3>
                    ...
                    <div className='SignUp-inp2'>
                        ...
                        <Form>
                            <Form.Check className='checkbox' type='checkbox' >
                                ...
                                <Form.Check.Label className='Small tx-gray'>Показати пароль</Form.Check.Label>
                            </Form.Check>
                        </Form>
                    </div>
                </div>
                <div className='SignUp-button-container'>
                    ...
                    <a className='link tx-blue Button-text-link-2' href='/login'>є акаунту</a>
                </div>
            </div>
        </div>
    );
